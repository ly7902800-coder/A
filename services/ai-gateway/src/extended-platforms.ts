import { CREATIVE_PLATFORMS, type CreativePlatform, type PlatformCategory } from "./creative-platforms.js";

export interface ExtendedPlatform extends CreativePlatform {
  integrationMode: "catalog" | "api" | "connector";
  permissionScopes: string[];
}
type PlatformTuple=[string,string,PlatformCategory,boolean,string[],string];

const EXTRA_PLATFORMS: PlatformTuple[] = [
  ...
  ["runway","Runway","media" as PlatformCategory,false,["video_generation","video_editing","image_generation"],"https://runwayml.com/"],
  ["adobe-firefly","Adobe Firefly","media" as PlatformCategory,false,["image_generation","video_generation","creative_tools"],"https://firefly.adobe.com/"],
  ["elevenlabs","ElevenLabs","media" as PlatformCategory,false,["text_to_speech","speech_to_text","voice"],"https://elevenlabs.io/"],
  ...
  ["descript","Descript","media" as PlatformCategory,false,["video_editing","transcription","audio"],"https://www.descript.com/"],
  ["shutterstock","Shutterstock","media" as PlatformCategory,false,["licensed_media","video","images","music"],"https://www.shutterstock.com/"],
  ["creative-cloud","Adobe Creative Cloud","media" as PlatformCategory,false,["creative_apps","video","image","audio"],"https://www.adobe.com/creativecloud.html"],
  ["kling","Kling AI","media" as PlatformCategory,false,["video_generation","image_generation"],"https://klingai.com/"],
  ["luma","Luma AI","media" as PlatformCategory,false,["video_generation","image_generation","3d"],"https://lumalabs.ai/"],
  ...
  ["playht","PlayHT","media" as PlatformCategory,false,["text_to_speech","voice"],"https://play.ht/"],
  ["elevenlabs-realtime","ElevenLabs Realtime","media" as PlatformCategory,false,["realtime_voice","speech"],"https://elevenlabs.io/"],
  ["cloudflare-realtime","Cloudflare Realtime","realtime" as PlatformCategory,true,["webrtc","audio","video","low_latency"],"https://developers.cloudflare.com/realtime/"],
  ...
  ["suno","Suno","media" as PlatformCategory,false,["music_generation","audio"],"https://suno.com/"]
];

export const EXTENDED_PLATFORMS: ExtendedPlatform[] = EXTRA_PLATFORMS.map(([id,name,category,freeTier,capabilities,website]) => ({
  id,name,category,freeTier,capabilities,adapterStatus:"catalog",website,integrationMode:"catalog",permissionScopes:["read"]
}));
